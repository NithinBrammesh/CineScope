...
\`\`\`env
PORT=4000
DATABASE\_URL=postgresql://postgres\:postgres\@localhost:5433/cinescope
NODE\_ENV=development
TMDB\_ACCESS\_TOKEN=your\_tmdb\_access\_token
TMDB\_BASE\_URL=https\://api.themoviedb.org/3
\`\`\`
